...
<main role="main">
    ...
    //limit phân trang lấy bản ghi 0 đến 21
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#load-more").on('click',function(event){
            //preventDefault() ngăn thẻ a chuyển hướng sang trang khác
            event.preventDefault();

            var params = {};
            params.current = $(".album-list").children('.col-md-4').length;// 9 bản ghi
            params.limit = 3;
            console.log(params);

            $.ajax({
                url:"http://localhost:8888/appAjax/ajax_sql/ajax.php",
                data: params,
                type: "POST",
                dataType:"json",
                beforeSend:function(){
